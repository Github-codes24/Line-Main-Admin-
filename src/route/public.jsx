...
const PublicRoutes = () => {
  return (
    <Routes>
      <Route path="/big-product-list" element={<BigProductList />} />
      <Route path="/big-product-add" element={<BigProductAdd />} />
      <Route path="/order/list" element={<ListOrder />} />
      <Route path="/pending-order/:id" element={<PendingOrder />} />
      <Route path="/progress-order/:id" element={<ProgressOrder />} />
      <Route path="/complete-order/:id" element={<CompleteOrder />} />
      <Route path="/reject-order/:id" element={<RejectOrder />} />
      <Route path="/big-product-view" element={<BigProductView />} />
      <Route path="/big-product-edit/:id" element={<BigProductEdit />} />
      <Route path="/big-product-approve/:id" element={<BigProductApprove />} />
