      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4 bg-white px-4 py-3 rounded-lg shadow">
        ...
        <div className="relative w-full max-w-xs flex-grow md:flex-grow-0">
          <input
            ...
            className="w-full pl-10 pr-4 bg-[#E4E5EB] text-[#001580] font-medium placeholder-[#333333] py-1 border-2 border-[#001580] rounded-full"
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-[#]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-4">
        ...
        <div className="border border-[#616666] rounded-lg shadow-sm overflow-x-auto">
          <table className="min-w-full bg-white shadow rounded-lg">
            <thead className="font-[Poppins] font-medium text-[16px] leading-[100%] tracking-[0%] text-center align-middle text-[#0D2E28]">
              ...
              {paginatedData.map((product, idx) => (
                <tr key={product.id} className="text-center">
                  ...
                  <td className="p-3 space-x-2">
                    <button
                      onClick={() =>
                        navigate(`/admin/smallproduct/view/${product.id}`)
                      }
                    >
                    ...
                    <button
                      onClick={() =>
                        navigate(`/admin/smallproduct/edit/${product.id}`)
                      }
                    >
                      <Edit className="text-red-600" size={20} />
                    </button>
