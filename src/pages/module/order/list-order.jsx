              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((order, idx) => (
                  <tr key={order.id} className="text-center">
                    ...
                    <td className={`px-3 py-5 font-medium ${statusColor[order.status]}`}>{order.status}</td>
          ...
          <div className="flex justify-between items-center mt-4 bg-[#F5F5F5] rounded-lg py-2 px-4">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-xl ${currentPage === 1 ? "bg-gray-200 text-[#001580]" : "bg-white hover:bg-gray-100"
                  }`}
              >
                &lt;
              </button>
              ...
              {[...Array(totalPages)].map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-8 h-8 flex items-center justify-center rounded-xl font-semibold ${page === currentPage ? "bg-[#001580] text-white" : "bg-[#CECEF2] text-[#001580] hover:bg-[#CECEF2]"
                      }`}
                  >
                    {page}
                  </button>
              ...
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-xl ${currentPage === totalPages ? "bg-gray-200 text-[#001580]" : "bg-white hover:bg-gray-100"
                  }`}
              >
                &gt;
              </button>
