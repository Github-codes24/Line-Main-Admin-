...
const OrderList = () => {
  ...
  return (
    ...
    // <div className="w-full min-h-screen bg-[#E0E9E9] p-4 md:p-8">
    // <div className="w-screen min-h-screen bg-[#E0E9E9]">
//     <div className="w-screen min-h-screen bg-[#E0E9E9] overflow-x-auto">
...
// {/* Header */}
// {/* <div className="bg-white p-1 shadow-md mb-4 rounded-md relative flex items-center w-full min-h-[65px]"> */}
...
//   {/* <div className="absolute left-1/2 transform -translate-x-1/2 w-full max-w-[400px]"> */}
//   {/* <div className="absolute left-0 right-0 mx-auto w-full max-w-[500px] px-4"> */}
...
//  {/* <div className="overflow-x-auto bg-white shadow-md rounded-lg w-full border border-gray-400"> */}
...
//           <h3 className="text-lg font-semibold text-[#0D2E28]">Expertise</h3> {/* color changed */}
//           <button
//             onClick={() => setShowFilterPanel(false)}
//             className="text-[#0D2E28] hover:text-[#0D2E28] text-2xl" // color changed
//           >
//             <IoClose />
//           </button>
//         </div>
...
//             <label
//               key={item}
//               className="flex items-center space-x-2 cursor-pointer text-[#0D2E28]" // color changed
//             >
//               <input
//                 type="checkbox"
//                 className="w-4 h-4 text-[#0D2E28] border-gray-300 rounded" // color changed
...
//           className="text-[#0D2E28] font-semibold ml-1" // color changed
//         >
//           <IoClose />
//         </button>
//       </span>
...
<div className="min-h-screen bg-[#E0E9E9] overflow-x-auto">
