                                ...
                                <table className=" border border-black">
                                    <thead className="">
                                        <tr>
                                            ...
                                            <th className="border-b border-black px-4 py-2">Products</th>
                                            <th className="border-b border-black px-4 py-2">Price</th>
                                            <th className="border-b border-black px-4 py-2">Qty</th>
                                            <th className="border-b border-black px-4 py-2">Amount</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                    ...
                    <div className="mb-6 ml-10">
                        ...
                        <div className="grid grid-cols-4 gap-4 mb-3">
                            ...
                            <input
                                disabled
                                value="Rejected"
                                className="col-span-1 px-4 py-2 rounded-lg bg-[#CED4F2] border border-[#001580] text-[#EF4444]"
                            />
                        </div>
                        <div className="grid grid-cols-4 gap-4 mb-3">
                            <label className="col-span-1 font-medium">Rejected By :</label>
                            <input
                                disabled
                                value="All Workers/All Shopkeepers"
                                className="col-span-1 px-4 py-2 rounded-lg bg-[#CED4F2] border border-[#001580]"
                            />
                        </div>
                        <div className="grid grid-cols-4 gap-4 mb-3">
                            <label className="col-span-1 font-medium">Reason :</label>
                            <input
                                disabled
