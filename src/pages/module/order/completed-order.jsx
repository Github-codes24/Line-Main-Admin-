      ...
      <div className="bg-white p-4 rounded-lg border shadow-sm">
        <div className="border border-[#616666] p-4 rounded-lg h-screen overflow-y-auto hide-scrollbar">
          ...
          <div className="mb-6 ml-10">
            ...
            <hr className="my-6 w-8/12" />
            <div className="grid grid-cols-4 gap-4">
              <label className="col-span-1 font-semibold text-lg">Customer <br />Feedback :</label>
              <input
                disabled
                value="Work Done"
                className="col-span-1 px-4 py-2 rounded-lg bg-[#CED4F2] border border-[#001580] text-[#22C55E]"
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <label className="col-span-1 font-semibold text-lg">Bill Uploaded <br />By Shopkeeper :</label>
              <div className="col-span-2">
                <img
                  src={rectangle}
                  alt="uploaded"
                  className="w-60 h-100 rounded-lg object-cover"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="col-span-2 overflow-x-auto">
                <table className="border border-black">
                  <thead className="">
                    <tr>
                      {/* <th className="border-b border-black p-2 font-normal">#</th> */}
                  ...
                  <tbody>
                    <tr>
                      {/* <td className="p-2 border-b border-black">1</td> */}
                    ...
                    <tr>
                      {/* <td className="p-2 border-b border-black">2</td> */}
                    ...
                    <tr>
                      {/* <td className="p-2 border-b border-black">3</td> */}
