...
export default function SetLimitAmount2() {
  ...
  const fetchLimit = async () => {
    ...
    setMsg("");
    try {
      const response = await fetch('https://linemen-be-1.onrender.com/admin/wallet/get-limit', {
        method: 'GET',
        headers: {
      ...
      setMsg("Error fetching wallet limit");
    } finally {
      setLoading(false);
    }
  };
  ...
  const onUpdate = async () => {
    ...
    setMsg("");
    try {
      const response = await fetch('https://linemen-be-1.onrender.com/admin/wallet/update-limit', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      setMsg("Error updating wallet limit");
    } finally {
      setLoading(false);
    }
  };
