    ...
    <div className="min-h-screen bg-gray-200 p-4 mb-30">
      <div className="">
        ...
        <div className="bg-white rounded-lg pt-3 h-96">
          ...
          <div className="border border-gray-300 rounded-lg px-6 py-12 mb-6 ml-4 mr-4 h-72" style={{ marginTop: '10px' }}>
          ...
          <div className="flex justify-center gap-4 px-6 pb-6">
            <button 
              ...
              onClick={() => alert("Set Limit Amount Updated successfully!")}
            >
              Update
            </button>
          </div>
