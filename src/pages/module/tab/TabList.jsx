    ...
    <div className="flex bg-[#E0E9E9] font-medium min-h-screen font-[Poppins]">
      <div className="flex-1 p-2 gap-2">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4 bg-white px-4 py-3 rounded-lg shadow">
          <h1 className="text-xl font-medium">Tab List</h1>
            ...
            <table className="w-full text-left bg-white p-4">
              <thead>
                <tr className="bg-[#E4E5EB]">
                  <th className="w-[80px] px-4 py-4 border-b text-[#0D2E28] text-[16px] font-medium text-center">
                    Sr.No.
                  </th>
                  <th className="w-[300px] px-4 py-4 border-b text-[#0D2E28] text-[16px] font-medium text-center">
                    Tab Name
                  </th>
                  <th className="w-[300px] px-4 py-4 border-b text-[#0D2E28] text-[16px] font-medium text-center">
                    Sub Tabs
                  </th>
                  <th className="w-[140px] px-4 py-4 border-b text-[#0D2E28] text-[16px] font-medium text-center">
                    Action
                  </th>
                </tr>
              </thead>
