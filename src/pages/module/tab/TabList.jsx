            ...
            <div className="flex justify-between items-center mt-4 bg-[#F5F5F5] rounded-lg py-2 px-4">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`w-8 h-8 flex items-center justify-center rounded-xl ${currentPage === 1
                ...
                {[...Array(totalPages)].map((_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 flex items-center justify-center rounded-xl font-semibold ${page === currentPage
                ...
                <button
                  ...
                  className={`w-8 h-8 flex items-center justify-center rounded-xl ${currentPage === totalPages
                    ? "bg-gray-200 text-[#001580]"
                    : "bg-white hover:bg-gray-100"
                    }`}
                >
