...
const TabEdit = () => {
  ...
  return (
    ...
    />
      ...
      {/* Form */}
      <div className="p-6 space-y-5 shadow-lg border-2 rounded-lg h-[78%] border-[#001580] m-4 ">
        {/* Tab Name */}
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            className="flex-1  rounded-md px-3 py-2 border-2 border-[#001580] bg-[#CED4F2] focus: outline-none"
          />
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-3 ">
            {subTabs.map((subTab, index) => (
              <div
                key={index}
                className="flex items-center gap-2 border-2 rounded-md px-3 py-2 bg-[#CED4F2] border-[#001580]"
              >
                <input
                  type="text"
                  value={subTab}
            ...
            <button
              ...
              className="text-m font-medium text-[#001580] hover:underline ml-[85%]"
            >
              + Add More Sub Tab
            </button>
          </div>
