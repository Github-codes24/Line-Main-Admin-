        ...
        <Form className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 mt-4 w-full">
            <button
              type="button"
              onClick={handleBack}
              className="border border-[#001580] text-[#001580] px-6 py-2 rounded-md hover:bg-[#CED4F2] bg-[#CED4F2] w-full md:w-auto"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isSubmitting || isLoading}
              className={`px-6 py-2 rounded-md text-white w-full md:w-auto ${
                isSubmitting || isLoading
                  ? "bg-gray-400 cursor-not-allowed"
                  : "bg-[#001580] hover:bg-[#CED4F2]"
              }`}
