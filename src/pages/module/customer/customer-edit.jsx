...
const EditCustomer = () => {
    ...
    return (
    <div className="min-h-screen bg-[#E0E9E9] flex flex-col p-2 overflow-auto">
  <ToastContainer />

  {/* Top Header Box */}
  <div className="w-full max-w-4xl mx-auto bg-white rounded-md shadow-md p-3 text-xl font-semibold flex items-center gap-2 mb-4">
    <svg
      width="28"
      height="28"
      viewBox="0 0 40 40"
  ...
  <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-md p-4 space-y-4">
    <Formik
        ...
        <Form className="space-y-4">
          ...
          <div className="border border-[#616666] rounded-lg p-4 min-h-[400px] space-y-4">
            <div className="flex items-center gap-4">
              ...
              <Field
                ...
                className="w-full border border-[#001580] rounded-md px-3 py-2 focus:outline-none bg-[#E4E5EB]"
              />
            ...
            <div className="flex items-center gap-4">
              ...
              <Field
                ...
                className="w-full border border-[#001580] rounded-md px-3 py-2 focus:outline-none bg-[#E4E5EB]"
              />
              <ErrorMessage name="contact" component="div" className="text-red-500 text-sm ml-2"/>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Field
                ...
                className="w-full border border-[#001580] rounded-md px-3 py-2 focus:outline-none bg-[#E4E5EB]"
              />
              <ErrorMessage name="address" component="div" className="text-red-500 text-sm ml-2"/>
            </div>
          </div>

          {/* Buttons outside the bordered div */}
          <div className="flex justify-center gap-4 mt-4">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-md text-white ${isSubmitting || isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#001580] hover:bg-[#CED4F2]'}`}
            >
