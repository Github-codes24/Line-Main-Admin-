...
const BigProductApprove = () => {
    ...
    return (
        <div className="p-2 flex flex-col items-start">
            <div className="w-[100%]">
                <div className="border rounded-t-md p-4 shadow bg-white flex items-center mb-3">
                ...
                {/* Product Details Box */}
                <div className="border border-t-0 rounded-b-xl p-6 shadow bg-white">
                    <div className="flex items-center gap-6 mb-6">
                        ...
                        <div className="rounded-lg p-2 w-[200px] h-[200px] flex items-center justify-center">
                            <img src={approveBig} alt="Product" className="max-h-full max-w-full object-contain" />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center mt-6 gap-4">
                        <button className="bg-teal-100 hover:bg-teal-200 text-teal-700 px-10 py-2 rounded-lg">
                            Reject
                        </button>
