...
//   totalOrders,
//   orderChange,
//   totalSales, // optional API has it
//   salesChange, // optional API has it
// }) => {
//   // Green Up Arrow
//   const GreenArrow = () => (
//     <svg
...
//       title: "Total Worker",
//       value: totalWorkers,
//       change: parseFloat(workerChange),
//       icon: (
//         <svg
//           width="25"
//           height="24"
...
//     {
//       title: "Total Sales",
//       value: totalSales || "₹ 0", // fallback if not in API
//       change: salesChange ? parseFloat(salesChange) : 0,
//       icon: (
//         <svg
//           width="24"
//           height="24"
...
//             <div className="flex items-center text-sm mt-1">
//               {card.arrow}
//               <span className={`ml-1 font-bold ${card.changeColor}`}>
//                 {card.change}
//               </span>
//               <span className="ml-2 text-white/80">This Month</span>
//             </div>
...
const TotalCardsPage = ({
  ...
  const cardData = [
    ...
    },
    {
      title: "Total Shop",
      value: totalShops,
        // value: totalSales || "₹ 0",  // fallback ensures it shows
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M3.20117 10V19C3.20117 20.1046 4.0966 21 5.20117 21H19.2012C20.3058 21 21.2012 20.1046 21.2012 19V10" stroke="white" strokeWidth="2"/>
          <path d="M15.0351 21V15C15.0351 13.8954 14.1397 13 13.0351 13H11.0351C9.93059 13 9.03516 13.8954 9.03516 15V21" stroke="white" strokeWidth="2" strokeMiterlimit="16"/>
          <path d="M22.0195 9.36418L20.3255 3.43517C20.2519 3.17759 20.0165 3 19.7486 3H15.7012L16.1765 8.70377C16.1921 8.89043 16.2935 9.05904 16.4544 9.15495C16.8437 9.38698 17.6064 9.81699 18.2012 10C19.217 10.3125 20.702 10.1998 21.5477 10.0958C21.8994 10.0526 22.1169 9.7049 22.0195 9.36418Z" stroke="white" strokeWidth="2"/>
          <path d="M14.2005 10C14.768 9.82538 15.4884 9.42589 15.8914 9.18807C16.0833 9.07486 16.1889 8.86103 16.1704 8.63904L15.7005 3H8.70052L8.2306 8.63904C8.2121 8.86103 8.31775 9.07486 8.50958 9.18807C8.91259 9.42589 9.63302 9.82538 10.2005 10C11.6935 10.4594 12.7075 10.4594 14.2005 10Z" stroke="white" strokeWidth="2"/>
          <path d="M4.07668 3.43517L2.38267 9.36418C2.28532 9.7049 2.50281 10.0526 2.85451 10.0958C3.70017 10.1998 5.18525 10.3125 6.20101 10C6.79578 9.81699 7.55852 9.38698 7.94779 9.15495C8.10868 9.05904 8.21014 8.89043 8.2257 8.70377L8.70101 3H4.65359C4.3857 3 4.15027 3.17759 4.07668 3.43517Z" stroke="white" strokeWidth="2"/>
        </svg>
      ),
      bg: "bg-gradient-to-b from-[#D98E4C] to-[#FFC999]",
      arrow: <GreenArrow />,
...

{
  ...
  bg: "bg-gradient-to-b from-[#D94C66] to-[#F28A9A] ", //  lighter red → deep red
  arrow: <RedArrow />, //  red arrow
  changeColor: "text-[#FF383C]", //  red text
}
